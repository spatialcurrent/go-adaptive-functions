...
func TestToStringArray(t *testing.T) {
	...
	testCases := []TestCase{
		NewTestCase([]interface{}{[]string{"x", "y"}}, ToStringArray, []string{"x", "y"}),
		NewTestCase([]interface{}{[]float64{12.0, 10.0}}, ToStringArray, []string{"12", "10"}),
		NewTestCase([]interface{}{[]uint8{uint8(12), uint8(10)}}, ToStringArray, []string{"12", "10"}),
		NewTestCase([]interface{}{[]interface{}{12, 10}}, ToStringArray, []string{"12", "10"}),
	}
